"""LLM-based goal planner — produces a numbered step list."""
...
def make_plan(goal: str, context: list[str], tools: list[str]) -> list[str]:
    ...
    Args:
        ...
        context: Recent memories relevant to the goal.
        tools:   One-liner descriptions of available tools.
    """
    ...
    return steps or [raw.strip()]  # fallback: whole response as single step
